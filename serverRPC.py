...
class Banco():
    ...
    def inserir_cliente(con, cnpj, qtd):
        ...
        if len(listClient) > 0:
            ...
            quantidade = int(cliente[1]) + int(qtd)
    ...
    def inserir_produto(con, nome, cnpj, qtd):
        ...
        if len(listProduct) > 0:
            ...
            quantidade = int(product[1]) + int(qtd)
...
def add(type, cnpj, nome, qtd):
    ...
    # print(f"add: {type}, {cnpj}, {nome}, {qtd}")
    # return "result add" 
...
def read(type, cnpj, nome = None):
    ...
    return len(value) > 0 and f'{value[0][1]}' or '0'
    # print(f"read: {type}, {cnpj}, {nome}")
    # return "result read"
...
def remove(type, cnpj, nome, qtd):
    ...
    # print(f"remove: {type}, {cnpj}, {nome}, {qtd}")
